...
void main() {
  group('ImageBuilder Adaptive Loading Tests', () {
    ...
    testWidgets('should use adaptive loading when enabled',
    ...
    testWidgets('should use non-adaptive loading when disabled',
        (WidgetTester tester) async {
    ...
    testWidgets('should default to adaptive loading when not specified',
        (WidgetTester tester) async {
    ...
    testWidgets(
        'should ignore adaptive loading when custom placeholder is provided',
        (WidgetTester tester) async {
