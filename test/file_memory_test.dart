...
void main() {
  group('ImageBuilder File and Memory Tests', () {
    ...
    testWidgets('should handle corrupted memory image data gracefully', (tester) async {
    ...
    testWidgets('should isolate constructor parameters properly', (tester) async {
      final testBytes = Uint8List.fromList([0x89, 0x50, 0x4E, 0x47]); // PNG header
